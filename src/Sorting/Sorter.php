...
class Sorter {
    ...
    public function sortGroupItems(array $groups, string $strategyService, SortDirection $direction = null): void {
     ...
     */
    public function sort(array &$array, string $strategyService, SortDirection $direction = null, bool $keepIndices = false): void {
